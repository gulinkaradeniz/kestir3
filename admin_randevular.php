                ...
                <div class="card-body">
                    ...
                    <?php include "includes/sistemmesaji.php" ?>
                        <div class="form-group text-center m-t-20">
                            <div class="col-12">
                                <button class="btn btn-primary btn-block btn-lg waves-effect waves-light" type="submit" onclick="javascript:location.href='randevu_al.php'">Randevu Oluştur</button>
                            </div><hr>
